...
// POST /api/admin/delivery-methods/upload - Upload delivery method logo
export async function POST(request) {
  try {
    ...
    const uploadDir = path.join(process.cwd(), 'public', 'uploads', 'delivery-methods');
    ...
    const publicUrl = `/uploads/delivery-methods/${filename}`;
