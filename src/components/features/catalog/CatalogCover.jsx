  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative h-full flex flex-col p-4 sm:p-6 md:p-8 z-10">
          {/* Company logo */}
          <div className="flex justify-center mb-4 sm:mb-5 md:mb-6 relative">
            <img
              src="/images/logo.svg"
              alt="DikaFood Logo"
              className="w-[120px] sm:w-[150px] md:w-[180px] h-auto relative z-10 drop-shadow-sm"
            />
          </div>

          {/* Title */}
          <div className={`text-center mb-auto ${locale === 'ar' ? 'rtl' : ''}`}>
            <span className="block text-dark-green-7 text-sm sm:text-base md:text-lg font-normal opacity-90 mb-2 sm:mb-3">
              2024
            </span>
            <div className="flex justify-center w-full">
              <div className="catalog-title-container">
                <span className="block font-catalog text-2xl sm:text-3xl md:text-4xl mb-2 sm:mb-3 md:mb-4 bg-gradient-to-r from-dark-green-7 to-dark-green-5 bg-clip-text text-transparent font-normal leading-[1.15] transition-all duration-300 drop-shadow-sm"
            ...
            <p className="text-dark-green-7 font-normal opacity-90 mt-1 sm:mt-2 text-xs sm:text-sm md:text-base lg:text-lg"
          ...
          <div className="mt-auto pt-4 md:pt-6">
            <div className="flex justify-center items-end mx-auto">
              <div className="flex items-end justify-center relative h-[180px] sm:h-[220px] md:h-[260px]">
                {/* Products lined up horizontally with proper proportions */}
                {/* Yellow plastic bottle - Chourouk 25L */}
                <div className="relative mx-[-8px] sm:mx-[-12px] md:mx-[-15px] z-[6] flex items-end">
                  <img
                    src="/images/products/chourouk-25L.png"
                    alt="Chourouk 25L"
                    className="h-auto w-[90px] sm:w-[110px] md:w-[130px] object-contain"
                    loading="lazy"
                  />
                </div>

                {/* Yellow tall bottle - Chourouk 10L */}
                <div className="relative mx-[-8px] sm:mx-[-12px] md:mx-[-15px] z-[5] flex items-end">
                  <img
                    src="/images/products/chourouk-10L.png"
                    alt="Chourouk 10L"
                    className="h-auto w-[80px] sm:w-[95px] md:w-[115px] object-contain"
                    loading="lazy"
                  />
                </div>

                {/* Small bottle - Biladi 1L */}
                <div className="relative mx-[-8px] sm:mx-[-12px] md:mx-[-15px] z-[4] flex items-end">
                  <img
                    src="/images/brands/biladi-logo.svg"
                    alt="Biladi 1L"
                    className="h-auto w-[60px] sm:w-[70px] md:w-[85px] object-contain"
                    loading="lazy"
                  />
                </div>

                {/* Box packaging - DikaFood box */}
                <div className="relative mx-[-8px] sm:mx-[-12px] md:mx-[-15px] z-[3] flex items-end">
                  <img
                    src="/images/products/dika-5L.png"
                    alt="Dika 5L Box"
                    className="h-auto w-[75px] sm:w-[90px] md:w-[110px] object-contain"
                    loading="lazy"
                  />
                </div>

                {/* Small round bottle - DikaFood 500ML */}
                <div className="relative mx-[-8px] sm:mx-[-12px] md:mx-[-15px] z-[2] flex items-end">
                  <img
                    src="/images/products/dika-500ML.png"
                    alt="Dika 500ML"
                    className="h-auto w-[55px] sm:w-[65px] md:w-[80px] object-contain"
                    loading="lazy"
                  />
                </div>

                {/* Small bottle with sunflower - Nouarti 1L */}
                <div className="relative mx-[-8px] sm:mx-[-12px] md:mx-[-15px] z-[1] flex items-end">
                  <img
